...
| 资源 | 类型 | 映射 |
|------|------|------|
| [[90_学习/03_课程资源/microsoft/02_microsoft_ai_for_beginners|Microsoft AI For Beginners]] | 课程 | 课程映射 |

## 规划中的资源索引

| 资源 | 类型 | 预计映射 |
|------|------|----------|
| DeepLearning.AI Short Courses | 课程 | → [[90_学习/03_课程资源/deeplearning_ai/01_short_courses]] |
| Hugging Face NLP Course | 课程 | → [[90_学习/03_课程资源/hugging_face/01_official_courses]] |
| Stanford CS229 | 课程 | 机器学习基础 |
| Stanford CS231n | 课程 | 计算机视觉 |
| Stanford CS224n | 课程 | NLP 与深度学习 |
| fast.ai | 课程 | 实用深度学习 |
| Dive into Deep Learning | 书籍 | 动手学深度学习 |
| Speech and Language Processing | 书籍 | NLP 经典教材 |
...
- [[20_论文精读/README]] — 必读论文
- [[90_学习/README]] — 学习路径
- [[00_入门/03_学习路径/02_AI学习资源]] — AI 学习资源
