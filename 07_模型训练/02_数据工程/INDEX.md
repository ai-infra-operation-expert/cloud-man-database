...
| 文件 | 说明 |
|------|------|
| [[07_模型训练/02_数据工程/04_数据_Curation_and_Mixture_2026|数据筛选与配比]] | 预训练数据筛选与混合策略 |
| [[07_模型训练/02_数据工程/Data_Augmentation|数据增强]] | 训练数据增强方法 |
...
- [[05_大模型/05_LLM数据工程/index|LLM Data Engineering]]
- [[11_模型运维/02_数据工程/index|Data Engineering]]
