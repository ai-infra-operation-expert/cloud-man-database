...
**Path:** News > DeepSeek-V3.2-Exp Release 2025/09/29
...
🔹 For comparison testing, V3.1-Terminus remains available via a temporary API until Oct 15th, 2025, 15:59 (UTC Time). Details: [https://api-docs.deepseek.com/guides/comparison_testing](https://api-docs.deepseek.com/guides/comparison_testing)
...
🔗 Tech report: [https://github.com/deepseek-ai/DeepSeek-V3.2-Exp/blob/main/DeepSeek_V3_2.pdf](https://github.com/deepseek-ai/DeepSeek-V3.2-Exp/blob/main/DeepSeek_V3_2.pdf)
