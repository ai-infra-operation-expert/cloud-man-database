...
**Path:** News > DeepSeek-V3.2 Release 2025/12/01
...
- 🔹 V3.2-Speciale: Served via a temporary endpoint: base_url="[https://api.deepseek.com/v3.2_speciale_expires_on_20251215](https://api.deepseek.com/v3.2_speciale_expires_on_20251215)". Same pricing as V3.2, no tool calls, available until Dec 15th, 2025, 15:59 (UTC Time).
- 💡 V3.2 now supports Thinking in Tool-Use — details: [https://api-docs.deepseek.com/guides/thinking_mode](https://api-docs.deepseek.com/guides/thinking_mode)
