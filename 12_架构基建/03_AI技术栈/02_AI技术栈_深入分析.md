...
| 文档 | 内容 | 适用角色 |
|------|------|----------|
| [AI Stack 生产工具链总览](./09_AI技术栈_生产_工具链.md) | 工具全景速查与生命周期流程图 | 所有 AI Stack 用户 |
| [容器与运行时](./01_AI技术栈_容器_Runtime_指南.md) | nerdctl / crictl / ctr / docker / podman | SRE、平台工程师 |
| [GPU 监控](./04_AI技术栈_GPU_监控_指南.md) | nvidia-smi / ppu-smi / rocm-smi / pmon | 运维、性能工程师 |
| [模型下载与管理](./08_AI技术栈_模型_Management_指南.md) | huggingface-cli / modelscope / git-lfs | 模型工程师 |
| [推理服务](./05_AI技术栈_推理_服务_指南.md) | vLLM / SGLang / Ollama / llama-server | 推理工程师 |
| [训练启动器](./10_AI技术栈_训练_发布ers_指南.md) | torchrun / accelerate / deepspeed / swift | 训练工程师 |
| [K8s 编排](./06_AI技术栈_K8s_Operations_指南.md) | kubectl / helm | K8s 工程师 |
| AI Stack 专属工具 | stackops / aioController | AI Stack 运维 |
